...
const zh = {
  ...
  trusted: '信任的动作源(每行一个源,如 https://example.com)',
  save: '保存',
  saved: '已保存',
  status: '助手形态',
  statusPanel: '侧边栏',
  ...
  blockedOriginsHint: '名单内的站点一律禁止操作(读取/动作/导航进入/绑定)。',
  openExport: '打开导出目录',
...
const en = {
  ...
  trusted: 'Trusted action origins (one per line, e.g. https://example.com)',
  save: 'Save',
  saved: 'Saved',
  ...
  blockedOriginsHint: 'Operations on these origins are always refused (reads, actions, navigation in, binding).',
